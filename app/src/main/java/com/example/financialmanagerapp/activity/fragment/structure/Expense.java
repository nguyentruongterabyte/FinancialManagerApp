...
public class Expense extends Fragment {
    ...
    private void handleYearChanged(Integer y) {
        year = y;
        // handle calculate expense amount;
        handleCalculateExpenseAmount();
        // add dataset
    ...
    private void initData() {
        ...
        transactions = Utils.filterTransactionsByType(transactions, Utils.EXPENSE_TRANSACTION_ID);
        // handle calculate expense amount;
        handleCalculateExpenseAmount();
        // init mChart
        setChart();
    ...
    private void handleCalculateExpenseAmount() {
        expenseAmount = 0;
        List<Transaction> transactionsByMonthOfYear = Utils.groupTransactionsByMonthOfYear(transactions, year, month);
